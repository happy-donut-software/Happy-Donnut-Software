...
const datosIniciales: DatosEmpresaType = {
  ...
  direccionEstablecimiento: "Av. Principal 123, Lima, Perú",
  celular: "987 654 321",
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={(e) => updateDato("direccionFiscal", e.target.value)}
              disabled={!isEditing}
          ...
          <div className="space-y-2">
            <Label htmlFor="direccionEstablecimiento">Dirección del Establecimiento</Label>
            <Textarea
              id="direccionEstablecimiento"
              value={datos.direccionEstablecimiento}
              onChange={(e) => updateDato("direccionEstablecimiento", e.target.value)}
              disabled={!isEditing}
              placeholder="Av. Principal 123, Lima, Perú"
              rows={2}
            />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                id="celular"
                value={datos.celular}
                onChange={(e) => updateDato("celular", e.target.value)}
                disabled={!isEditing}
