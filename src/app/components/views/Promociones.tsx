...
import { Search, Eye, Trash2, Tag, ShoppingBag, AlertCircle } from "lucide-react";
...
export function Promociones({ userRole }: PromocionesProps) {
    ...
    <div className="p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          {isReadOnly ? "Consulta las promociones de productos" : "Gestiona las promociones de productos"}
        </p>
      </div>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="text-right">{isReadOnly ? "Detalles" : "Acciones"}</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
